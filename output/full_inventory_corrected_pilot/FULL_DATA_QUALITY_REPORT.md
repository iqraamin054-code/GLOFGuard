...
| Failed lakes | 0 |
| Lakes without usable imagery | 19 |
| Stale observations | 0 |
| Exact duplicate source polygons excluded | 2 |
| Pending lakes | 8,766 |
| REAL observations | 40 |
| MOCK observations | 0 |

## Source-specific availability and freshness

- Satellite-area freshness: {'UNAVAILABLE': 8787, 'FRESH': 16, 'STALE': 5}
- Observed-weather freshness: {'UNAVAILABLE': 8768, 'FRESH': 40}
- Observed-weather data quality: {'MISSING': 8768, 'PARTIAL': 40}
- Forecast freshness: {'UNAVAILABLE': 8768, 'FRESH': 40}
- Forecast data quality: {'MISSING': 8768, 'PARTIAL': 40}
- Historical-baseline availability: {'UNAVAILABLE': 8768, 'AVAILABLE': 40}
...
- Latest usable satellite observation: 2026-08-29T05:59:38.677000+00:00
...
- Sentinel-2 / ProviderError: 2 attempt(s)
