...
Exact command used: `"C:\Users\Essa Ahmed\Desktop\Ayesha\GLOF\.python\python.exe" -m glofguard.cli full-inventory --output-dir output\full_inventory_corrected_v2_smoke --max-lakes 1 --batch-size 1 --rate-limit-seconds 1.0 --max-retries 2 --backoff-base-seconds 2 --backoff-cap-seconds 10`
...
| Failed lakes | 0 |
| Lakes without usable imagery | 1 |
...
- Satellite-area freshness: {'UNAVAILABLE': 8808}
- Observed-weather freshness: {'UNAVAILABLE': 8807, 'FRESH': 1}
- Observed-weather data quality: {'MISSING': 8807, 'COMPLETE': 1}
- Forecast freshness: {'UNAVAILABLE': 8807, 'FRESH': 1}
- Forecast data quality: {'MISSING': 8807, 'COMPLETE': 1}
- Historical-baseline availability: {'UNAVAILABLE': 8807, 'AVAILABLE': 1}
...
- Earliest usable satellite observation: Unavailable
- Latest usable satellite observation: Unavailable
